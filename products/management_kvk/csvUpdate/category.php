			...
			<div class="row">
				...
				<div class="col-md-10">
					<ul class="nav nav-tabs">
						<li><a href="itemStatusMaster.php">アイコンマスタ</a></li>
						<li class="active"><a href="#">商品カテゴリマスタ</a></li>
					</ul>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<div class="input-group">
									<input type="text" id="filepath" name="filepath" class="form-control" value="<?php echo $viewFilePath ?>"  placeholder="category_master.csv">
