<?php
	include(dirname(__FILE__) . '/../../system/page/importcsv/ImportCsvItemStatus.php');
	include(dirname(__FILE__) . '/../../system/page/exportcsv/ExportCsvItemStatus.php');
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<div class="input-group">
									<input type="text" id="filepath" name="filepath" class="form-control" value="<?php echo $viewFilePath ?>" placeholder="item_status.csv">
