...
/* ---------------------------¿ﬂƒÅE˝À°----------------------------------------
•ÅEÛ•Ø§À class="thickbox"§Ú§ƒ§±§ÅEŒ„°À°À°À<a href="../../../js/shadowbox/photo/1.jpg" class="thickbox"><img src="../../../js/shadowbox/thumbnail/1.jpg"></a>
---------------------------------------------------------------------------- */
...
function TB_show(caption, url, imageGroup) {//function called when the user clicks on a thickbox link
	...
	try {
	   ...
	   var urlString = /\.jpg|\.jpeg|\.png|\.gif|\.bmp|\.php/g;
