...
var scrolltotop={
	...
	controlHTML: '<img src="/common/img/icon_pagetop.png" style="width:50px; height:50px" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
	...
	init:function(){
		jQuery(document).ready(function($){
			...
			mainobj.$control=$('<div id="topcontrol">'+mainobj.controlHTML+'</div>')
				.css({position:mainobj.cssfixedsupport? 'fixed' : 'absolute', bottom:/*mainobj.controlattrs.offsety*/100, right:mainobj.controlattrs.offsetx, opacity:0, cursor:'pointer'})
